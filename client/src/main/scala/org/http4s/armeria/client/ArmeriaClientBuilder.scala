...
object ArmeriaClientBuilder {
  ...
  def apply[F[_]](clientBuilder: WebClientBuilder = WebClient.builder())(implicit
      F: ConcurrentEffect[F],
      C: ContextShift[F]): ArmeriaClientBuilder[F] =
    new ArmeriaClientBuilder(clientBuilder)(F, C)
  ...
  def apply[F[_]](uri: String)(implicit
      F: ConcurrentEffect[F],
      C: ContextShift[F]): Either[IllegalArgumentException, ArmeriaClientBuilder[F]] =
  ...
  /** Returns a new [[ArmeriaClientBuilder]] created with the specified base [[java.net.URI]].
    ...
    */
  def unsafe[F[_]](
      uri: String)(implicit F: ConcurrentEffect[F], C: ContextShift[F]): ArmeriaClientBuilder[F] =
  ...
  /** Returns a new [[ArmeriaClientBuilder]] created with the specified base [[java.net.URI]].
    ...
    */
  def unsafe[F[_]](
      uri: URI)(implicit F: ConcurrentEffect[F], C: ContextShift[F]): ArmeriaClientBuilder[F] =
    apply(WebClient.builder(uri))
}
